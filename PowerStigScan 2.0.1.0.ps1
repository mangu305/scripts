...
# URL - https://www.powershellgallery.com/packages/PowerStigScan/2.0.1.0/Content/Common%5CPowerStigScan.Scap.ps1

#region PowerStig Scap Version Map
...
#region Convert Scap Role to PowerStig
...
#region PowerStig Scap Basic Options
